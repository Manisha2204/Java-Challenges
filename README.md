...
* **Challenge:** Create a simple Bank Application in Java with basic operations (deposit, withdraw, balance check).  

* **Approach:**  
  * Created a `BankAccount` class with account holder name, account number, and balance.  
...
Operations:
Deposit 500 to 1001 → Balance = 2500
Withdraw 700 from 1002 → Balance = 800
Withdraw 2000 from 1003 → Insufficient balance (Balance = 1000)
Check balance of 1004 → Balance = 3000
Deposit 1000 to 1005 → Balance = 6000
